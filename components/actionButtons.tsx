...
export const NewButton = ()=>{
    ...
    const AddSvg=()=>{ return <svg className="mx-2 bg-black/10 dark:bg-white/10 rounded-full" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="2rem" height="2rem" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><path fill="currentColor" d="M16 4c6.6 0 12 5.4 12 12s-5.4 12-12 12S4 22.6 4 16S9.4 4 16 4m0-2C8.3 2 2 8.3 2 16s6.3 14 14 14s14-6.3 14-14S23.7 2 16 2z"/><path fill="currentColor" d="M24 15h-7V8h-2v7H8v2h7v7h2v-7h7z"/></svg> }
    return(
        <>
            <button className={`${fnt.title__font} dark:text-white p-2 mx-1 bg-sky-200 dark:bg-sky-600 rounded-md border-4 border-black/60 dark:border-white/60 flex justify-between items-center`} onClick={()=>handleViewAction()}><AddSvg/>{' '}Create a new bug report</button>
        </>
    )
}
