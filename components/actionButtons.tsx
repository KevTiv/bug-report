...
const ModifyButton = ({bugId, isPrivilege}:buttonType)=>{
    ...
    return(
        <>
            <button className={`m-2 bg-black/5 hover:bg-black/20 dark:bg-white/20 hover:dark:bg-white/40 dark:text-white w-12 h-12 rounded-md flex justify-center items-center`} onClick={()=>handleModifyAction()}><ModifySVG/></button>
        </>
    )
}
const DeleteButton = ({bugId, isPrivilege}:buttonType)=>{
    ...
    return(
        <>
            <button className={`m-2 bg-black/5 hover:bg-black/20 dark:bg-white/20 hover:dark:bg-white/40 dark:text-white w-12 h-12 rounded-md flex justify-center items-center`} onClick={()=>handleDeleteAction()}><DeleteSVG/></button>
        </>
    )
}
