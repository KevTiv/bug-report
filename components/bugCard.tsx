...
export const LatestResolvedBugCard = ({latestResolvedBug}:bugType[]) => {
  return (
    <>
        <div className="w-full border-2 border-emerald-700/10 dark:border-emerald-200/10 rounded-md bg-emerald-700/10 dark:bg-emerald-200/10 dark:text-white  py-2">
...
export const LatestUnresolvedBugCard = ({latestUnresolvedBug}:bugType[]) => {
  return (
    <>
        <div className="w-full border-2 border-red-600/10 dark:border-red-200/10 rounded-md bg-red-600/10 dark:bg-red-200/10 dark:text-white py-2">
