...
const Login = () => {
  ...
  return (
    <>
      ...
      <button type="button" onClick={()=>handleGitHubLogin()} className="text-white dark:text-black bg-[#24292F] dark:bg-[#d1d2d4] hover:bg-[#24292F]/90 dark:hover:bg-[#d1d2d4]/90 focus:ring-4 focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500  mr-2 mb-2">
