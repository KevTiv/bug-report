    ...
    return(
        <>
            <nav className="flex items-center justify-between h-32 w-full overflow-hidden">
                ...
                <ul ref={burgerMenuRef} className={`${componentStyle.mobile__burger__menu__content} bg-white dark:bg-black absolute w-full h-1 flex-col top-32 left-0 z-10 border-b-2 rounded-lg border-black dark:border-white`}>
